...
function printDeliveryTicket(orderId) {
    ...
    let printHTML = `<div class="ticket" style="text-align: left; font-family: monospace; font-size: 11px; width: 58mm; padding: 5px; color: black; background: white;"><div style="text-align: center;"><h3 style="font-size: 14px; margin-bottom: 2px;">Conteiner Beer</h3><p style="font-size: 12px; margin: 0; font-weight:bold;">-- PEDIDO #${orderCode} --</p></div><div style="border-bottom: 1px dashed #000; margin-bottom: 6px;"></div><table style="width: 100%; font-size: 11px; margin-bottom: 5px;"><tr><th style="text-align:left;">Qtd</th><th style="text-align:left;">Produto</th></tr>`;
...
// ================= GERENCIAR CATEGORIAS NO ADMIN (COM VISIBILIDADE SITE) =================
